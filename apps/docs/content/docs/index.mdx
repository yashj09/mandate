---
title: Mandate
description: Claude executes real on-chain financial actions for you, inside limits you set, with a hardware tap for anything irreversible.
---
...
```mermaid
flowchart TB
  U[You: chat or MCP] --> A[Claude drafts an intent]
...
| Console | `apps/web` | Next.js chat and owner console with Ledger WebHID approvals, live at [creditline-web.vercel.app](https://creditline-web.vercel.app) |
