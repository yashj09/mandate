...
export const CONSOLE_URL = "https://mandateagents.vercel.app";
...
export function baseOptions(): BaseLayoutProps {
  return {
    ...
    links: [
      ...
      // A labelled link, not `githubUrl`: fumadocs renders that as an icon-only button with no visible text.
      { text: "GitHub", url: GITHUB_URL, external: true, icon: <GitHubMark /> },
    ],
  };
}
